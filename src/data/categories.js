// Category data for Bgiya Bliss — Based on actual Amazon product listings

export const navLinks = [
  {
    name: 'Potting Mix',
    link: '/collections/potting-mix',
    megaMenu: [
      {
        title: 'Potting Mixes',
        items: [
    ...
    megaMenu: [
      {
        ...
        items: [
          { name: 'Gardening Pruner', link: '/products/gardening-pruner-tool' },
          { name: 'More Tools Coming Soon', link: '/products/coming-soon' },
        ],
      },
    ],
  },
  { name: 'Offers', link: '/collections/offers', megaMenu: null, highlight: true },
];
